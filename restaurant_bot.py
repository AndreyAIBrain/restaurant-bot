...
CATEGORIES = {
    "soups": {"title": "🥣 Супы", "dishes": {
        "borscht": {"title": "🍜 Борщ 200", "img": "hot/Borscht Soup.jpg", "desc": "Борщ с говядиной — ароматный наваристый суп с сочными кусочками мяса, свежей капустой и свёклой, в насыщенном пряном бульоне. Подаётся со сметаной и зеленью. Настоящая классика русской кухни.", "price": 200, "emoji": "🥣"},
        "beetroot": {"title": "🥣 Свекольник 150", "img": "hot/Beetroot soup.jpg", "desc": "Свекольник классический — лёгкий и освежающий холодный суп на основе отварной свёклы, с хрустящими овощами и ароматной зеленью. Идеален для тёплой погоды. Подаётся со сметаной и яйцом.", "price": 150, "emoji": "🥣"},
        "okroshka": {"title": "🍲 Окрошка 200", "img": "hot/Okroshka soup.jpg", "desc": "Окрошка на кефире — лёгкий и освежающий холодный суп с хрустящими овощами, ароматной зеленью и нежным мясом. Идеальное блюдо для жаркого дня.", "price": 200, "emoji": "🥣"},
        "solyanka": {"title": "🫒 Солянка 200", "img": "hot/Solyanka soup.jpg", "desc": "Солянка с говядиной — густой пряный суп с нежными кусочками мяса, ароматом копчёностей, солёных огурцов и маслин. Богатый вкус с лёгкой остринкой. Подаётся с лимоном и сметаной. Настоящее удовольствие для ценителей русской кухни.", "price": 200, "emoji": "🥣"},
    }},
    "main": {"title": "🍖 Горячие блюда", "dishes": {
        "beef_goulash": {"title": "🥘 Говяжий гуляш 130", "img": "main/Beef goulash.jpg", "desc": "Гуляш из говядины — ароматное мясо в насыщенном соусе с пряностями, сытное и согревающее блюдо домашней кухни.", "price": 130, "emoji": "🍖"},
        "beef_patties": {"title": "🥩 Котлеты из говядины 130", "img": "main/Beef patties with gravy.jpg", "desc": "Нежнейшие котлеты из сочной говядины под ароматной подливой — сытное и домашнее блюдо, которое радует вкусом и уютом.", "price": 130, "emoji": "🍖"},
        "buckwheat_beef": {"title": "🥩 Гречка с говядиной 220", "img": "main/Buckwheat with beef patties and gravy.jpg", "desc": "Гречка с говяжьими котлетами и подливой — сытное и ароматное блюдо: рассыпчатая гречка, сочные котлеты из говядины и нежная домашняя подлива. Настоящая классика для вкусного обеда.", "price": 220, "emoji": "🍖"},
        "buckwheat_chicken": {"title": "🍗 Гречка с курицей 220", "img": "main/Buckwheat with chicken goulash.jpg", "desc": "Гречка с куриным гуляшом — нежное куриное филе в пряном соусе с рассыпчатой гречкой. Сытное и уютное блюдо для вкусного обеда.", "price": 220, "emoji": "🍗"},
        "mashed_beef": {"title": "🥩 Пюре с говядиной 220", "img": "main/Mashed potatoes with beef patties and gravy.jpg", "desc": "Картофельное пюре с котлетами из сочной говядины под нежной подливой — сытное и домашнее блюдо, которое дарит тепло и вкус детства.", "price": 220, "emoji": "🍖"},
        "mashed_chicken": {"title": "🍗 Пюре с курицей 220", "img": "main/Mashed potatoes with chicken goulash.jpg", "desc": "Пюре с куриным гуляшом — нежное картофельное пюре с сочным куриным филе в ароматном соусе. Вкусное и сытное блюдо домашней кухни.", "price": 220, "emoji": "🍗"},
        "mashed_gravy": {"title": "🥣 Пюре с подливой 220", "img": "main/Mashed potatoes with gravy.jpg", "desc": "Картофельное пюре с подливой из говядины — нежное пюре под насыщенным мясным соусом, согревающее и сытное блюдо домашней кухни.", "price": 220, "emoji": "🥣"},
        "mashed": {"title": "🥔 Пюре 100", "img": "main/Mashed potatoes.jpg", "desc": "Картофельное пюре — нежное и воздушное, приготовленное по классическому рецепту, идеальное дополнение к любому блюду.", "price": 100, "emoji": "🥔"},
        "buckwheat": {"title": "🌾 Гречка 100", "img": "main/Open buckwheat.jpg", "desc": "Гречка отварная — лёгкий и полезный гарнир с нежным вкусом и ароматом, идеально дополняющий любое блюдо.", "price": 100, "emoji": "🌾"},
        "spaghetti_beef": {"title": "🍝 Спагетти с говядиной 230", "img": "main/Spaghetti with beef patties and gravy.jpg", "desc": "Спагетти с сочными говяжьими котлетами и нежной подливой — сытное и аппетитное блюдо, которое дарит вкус домашнего уюта.", "price": 230, "emoji": "🍝"},
        "spaghetti_chicken": {"title": "🍗 Спагетти с курицей 220", "img": "main/Spaghetti with chicken goulash.jpg", "desc": "Спагетти с куриным гуляшом — нежная паста с сочным куриным филе в ароматном соусе. Сытное и аппетитное блюдо для настоящего домашнего обеда.", "price": 220, "emoji": "🍝"},
        "spaghetti_gravy": {"title": "🧆 Спагетти с подливой 220", "img": "main/Spaghetti with gravy (Спагетти с подливой из говядины).jpg", "desc": "Спагетти с подливой из говядины — нежная паста с насыщенным мясным соусом, сытное и вкусное блюдо домашнего уюта.", "price": 220, "emoji": "🍝"},
        "spaghetti": {"title": "🍝 Спагетти 100", "img": "main/Spaghetti.jpg", "desc": "Спагетти — нежные, идеально сваренные макароны, которые станут отличной основой для вашего любимого соуса или гарниром к любому блюду.", "price": 100, "emoji": "🍝"},
    }},
    "salads": {"title": "🥗 Салаты", "dishes": {
        "crab": {"title": "🦀 Крабовый салат 150", "img": "salads/Crab salad.jpg", "desc": "Крабовый салат — нежный и сочный, с крабовыми палочками, яйцом, кукурузой и свежим огурцом. Заправка придаёт блюду воздушную текстуру и тонкий вкус. Классика, которая всегда в удовольствии.", "price": 150, "emoji": "🥗"},
        "olivier": {"title": "🥚 Салат Оливье 150", "img": "salads/Olivier salad.jpg", "desc": "Салат Оливье с колбасой — аппетитный и сытный, с нежным картофелем, сочным огурчиком, зелёным горошком и ароматной колбасой. Классический вкус, знакомый и любимый с детства.", "price": 150, "emoji": "🥗"},
        "summer": {"title": "🥒 Летний салат 150", "img": "salads/Summer salad.jpg", "desc": "Летний салат с сладким луком, сочным перцем и спелыми томатами черри — свежий, яркий и ароматный. Лёгкая заправка подчёркивает натуральный вкус овощей. Настоящее наслаждение в каждом кусочке!", "price": 150, "emoji": "🥒"},
    }},
    "snacks": {"title": "🥪 Закуски", "dishes": {
        "nuggets": {"title": "🍗 Куриные наггетсы 100", "img": "snacks/Chicken nuggets.jpg", "desc": "Куриные наггетсы — хрустящие снаружи и сочные внутри, аппетитная закуска, любимая и взрослыми, и детьми.", "price": 100, "emoji": "🍗"},
        "greens": {"title": "🥬 Свежая зелень 30", "img": "snacks/Fresh greens.jpg", "desc": "Ассорти свежей зелени.", "price": 30, "emoji": "🥬"},
        "pickles": {"title": "🥒 Домашние солёные огурцы 100", "img": "snacks/Homemade pickled cucumbers.jpg", "desc": "Солёные огурцы собственного приготовления.", "price": 100, "emoji": "🥒"},
        "pancakes": {"title": "🥔 Драники 100", "img": "snacks/Potato pancakes.jpg", "desc": "Драники картофельные — золотистые, хрустящие снаружи и мягкие внутри, классические домашние лепёшки из тёртого картофеля.", "price": 100, "emoji": "🥔"},
    }},
    "drinks": {"title": "🥤 Напитки", "dishes": {
        "water": {"title": "💧 Вода 40", "img": "drinks/Water.jpg", "desc": "Питьевая вода без газа.", "price": 40, "emoji": "💧"},
        "coca_cola": {"title": "🥤 Кока-Кола 50", "img": "drinks/Coca-Cola.jpg", "desc": "Классическая Coca-Cola.", "price": 50, "emoji": "🥤"},
        "sprite": {"title": "🍐 Спрайт 50", "img": "drinks/Sprite.jpg", "desc": "Sprite", "price": 50, "emoji": "🥤"},
        "fanta": {"title": "🍊 Фанта 50", "img": "drinks/Fanta.jpg", "desc": "Fanta с апельсиновым вкусом.", "price": 50, "emoji": "🥤"},
        "mango_juice": {"title": "🥭 Манговый сок 140", "img": "drinks/MANGO JUICE.jpg", "desc": "Сок из манго.", "price": 140, "emoji": "🥭"},
        "passion_fruit_juice": {"title": "🥭 Сок маракуйи 140", "img": "drinks/PASSION FRUIT JUICE.jpg", "desc": "Сок из маракуйи.", "price": 140, "emoji": "🍹"},
        "tomato_juice": {"title": "🍅 Томатный сок 140", "img": "drinks/Tomato JUICE.jpg", "desc": "Томатный сок.", "price": 140, "emoji": "🍅"},
    }},
    "sauces": {"title": "🥫 Соусы", "dishes": {
        "ketchup": {"title": "🍅 Кетчуп 25", "img": "sauces/Ketchup.jpg", "desc": "Кетчуп томатный.", "price": 25, "emoji": "🥫"},
        "mayo": {"title": "🥚 Майонез 25", "img": "sauces/Mayonnaise.jpg", "desc": "Майонез классический.", "price": 25, "emoji": "🥛"},
        "sour_cream": {"title": "🥛 Сметана 30", "img": "sauces/Sour cream.jpg", "desc": "Сметана домашняя.", "price": 30, "emoji": "🥛"},
    }},
}
